...
public class DiscView extends FrameLayout {
    ...
    public void setValue(int displayValue,int total) {
        setValue(displayValue,total, ANIMATION_DURING);
    }
     ...
     * @param duration 延时
     */
    public void setValue(final int displayValue,final int total, int duration) {
        ...
        animator = ValueAnimator.ofInt(0, displayValue);
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                int kValue = (int)(((double)value/(double)total)*360);
                System.out.println(kValue);
                mCircleView.setValue(kValue);
                contentValueText.setText(value +"KM");
            }
        });
