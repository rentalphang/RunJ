...
public abstract class PlatformPage extends OnekeySharePage {
	...
	public void onCreate() {
		activity.getWindow().setBackgroundDrawable(new ColorDrawable(0x0000));
		initAnims();
		...
		TextView backLine = new TextView(activity);
		backLine.setWidth(LayoutParams.MATCH_PARENT);
		backLine.setHeight(5);
		backLine.setBackgroundColor(0x000);
		LinearLayout.LayoutParams lpLine = new LinearLayout.LayoutParams(
				LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
		llPage.addView(backLine,lpLine);
